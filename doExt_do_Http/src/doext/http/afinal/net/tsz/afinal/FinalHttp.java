 ...
 */
package doext.http.afinal.net.tsz.afinal;
...
import doext.http.afinal.net.tsz.afinal.http.AjaxParams;
import doext.http.afinal.net.tsz.afinal.http.HttpHandler;
import doext.http.afinal.net.tsz.afinal.http.RetryHandler;
import doext.http.afinal.net.tsz.afinal.http.SyncRequestHandler;
...
//		schemeRegistry.register(new Scheme("https", SSLSocketFactory.getSocketFactory(), 443));
	...
	//---------------------下载---------------------------------------
	public HttpHandler<File> download(String url, String target, AjaxCallBack<File> callback, String taskId) {
		return download(url, null, target, false, callback, taskId);
	}

	public HttpHandler<File> download(String url, String target, boolean isResume, AjaxCallBack<File> callback, String taskId) {
		return download(url, null, target, isResume, callback, taskId);
	}

	public HttpHandler<File> download(String url, AjaxParams params, String target, AjaxCallBack<File> callback, String taskId) {
		return download(url, params, target, false, callback, taskId);
	}

	public HttpHandler<File> download(String url, AjaxParams params, String target, boolean isResume, AjaxCallBack<File> callback, String taskId) {
		...
		handler.executeOnExecutor(executor, get, target, isResume, taskId);
		return handler;
	}
