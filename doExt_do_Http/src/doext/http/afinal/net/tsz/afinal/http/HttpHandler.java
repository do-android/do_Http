 ...
 */
package doext.http.afinal.net.tsz.afinal.http;
...
import doext.http.afinal.net.tsz.afinal.core.AsyncTask;
import doext.http.afinal.net.tsz.afinal.http.entityhandler.EntityCallBack;
import doext.http.afinal.net.tsz.afinal.http.entityhandler.FileEntityHandler;
import doext.http.afinal.net.tsz.afinal.http.entityhandler.StringEntityHandler;
...
public class HttpHandler<T> extends AsyncTask<Object, Object, Object> implements EntityCallBack {
	...
	protected Object doInBackground(Object... params) {
		if (params != null && params.length == 4) {
			...
			taskId = String.valueOf(params[3]);
		}
		try {
	...
	protected void onProgressUpdate(Object... values) {
		...
		case UPDATE_FAILURE:
			if (callback != null)
				callback.onFailure((Throwable) values[1], (Integer) values[2], (String) values[3], taskId);
			break;
		case UPDATE_SUCCESS:
			if (callback != null)
				callback.onSuccess((T) values[1], taskId);
			break;
		default:
			break;
		}
