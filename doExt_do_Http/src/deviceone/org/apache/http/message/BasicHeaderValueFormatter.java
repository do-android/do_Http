...
package deviceone.org.apache.http.message;
...
public class BasicHeaderValueFormatter implements HeaderValueFormatter {
	 ...
	 * @param formatter
	 *            the formatter to use, or {@code null} for the
	 ...
	 * @param quote
	 *            {@code true} to always format with quotes, {@code false} to
	 ...
	 *
	 * @return {@code true} if the character is a separator, {@code false}
	 *         otherwise
	 */
